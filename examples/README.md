...
Sessions explicitly. Each API demonstrates synchronous execution through a
reusable Session (`POST /execute`) and durable asynchronous execution through
`app.executions.dispatch` (`POST /dispatch`); direct client streaming is
