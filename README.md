...
export default defineHarness<Input, RuntimeEvent>(
...
The user-defined harness function owns message settlement. Resolving completes
...
Native harness messages can emit application-defined events. Edge Session
